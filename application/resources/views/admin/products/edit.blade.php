                ...
                <div class="card-body">
                    <form id="productCreateForm" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    <label for="name" class="font-weight-bold">@lang('Title')</label>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="demo_link" id="demo_link" value="{{ $product->demo_link }}"
                                        class="form-control" required>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label for="external_link" class="font-weight-bold">@lang('External Link')</label>
                            ...
                            <div class="col-lg-12">
                                <div class="row form-group">
                                    ...
                                    <div class="col-2">
                                        <button type="button" class="btn btn--primary addProductImage ms-0"><i
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control trumEdit " name="description" id="descripton" rows="3">@php echo $product->description @endphp</textarea>
                                </div>
                            </div>
    ...
    <script>
        (function($) {
            ...
            $('#productCreateForm').submit(function(e) {
                ...
                xhr.open("POST", "{{ route('admin.product.update') }}");

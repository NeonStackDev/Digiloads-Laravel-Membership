    ...
    <div class="col-xl-4 col-lg-6 col-md-6">
        <div class="card_body">
            ...
            <div class="content">
                ...
                <div class="card-meta">
                    <div class="sale">
                        <p class="amount"><i class="fas fa-bolt"></i> {{$product->sale}} @lang('sales')</p>
                    ...
                    <div class="btm">
                        ...
                        <div class="cart">
                            ...
                            @elseif($product->is_free != 1 && $membership == null)
                            <a href="{{route('user.product.payment',$product->id)}}" class="btn btn--base btn--sm"><i class="fas fa-cart-plus"></i> @lang('Purchase')</a>
                            @else($product->is_free != 1 && $membership != null)
                            <a class="btn btn--base btn--sm" href="{{ route('user.product.preminum.download', ['id' => $product->id]) }}">
                                <i class="fas fa-download"></i>
                            </a>
                            <button class="btn btn--base btn--sm copy-link-btn"
                                data-link="{{ $product->external_link }}"
